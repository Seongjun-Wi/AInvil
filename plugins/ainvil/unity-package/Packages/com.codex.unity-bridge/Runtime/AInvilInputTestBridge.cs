...
{
    /// <summary>
    /// Compatibility/sample runtime bridge for repeatable Play Mode input validation.
    /// New operational validation scenarios should prefer AInvilRuntimeInputTestBridge.
    /// It records input commands and exposes UnityEvents that project-specific
    /// input adapters can wire to the real game input system.
    /// </summary>
    [DisallowMultipleComponent]
    public sealed class AInvilInputTestBridge : MonoBehaviour
    {
        [Serializable]
        ...
        private void EnsureCanAcceptCommand()
        {
            ...
            {
                throw new InvalidOperationException("AInvilInputTestBridge only accepts commands in Play Mode unless acceptCommandsOutsidePlayMode is enabled.");
            }
        }
